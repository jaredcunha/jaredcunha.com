...
<PhotoGrid caption="Our hotel outside of Vík and some areas along the walking trail.">
	<PhotoGridItem cols={6} src="/images/iceland-2018/black-sand.jpg" alt="Black sand in the foreground with a mountain covered in clouds in the background" />
	<PhotoGridItem cols={6} src="/images/iceland-2018/hotel-lupine.jpg" alt="Narrow depth of the field with a patch of lupines in focus in the foreground and the hotel blurred in the background." />
	<PhotoGridItem cols={12} src="/images/iceland-2018/hotel.jpg" alt="Umi Hotel looking stoic against the grasses" />
</PhotoGrid>
...
<Image
	src="/images/iceland-2018/mirna-black-sand.jpg"
...
<Image
	src="/images/iceland-2018/basalt.jpg"
	alt="Basalt columns"
...
<PhotoGrid caption="Kayaking in the glacier lake">
	<PhotoGridItem cols={6} src="/images/iceland-2018/kayak1.jpg" alt="Kayaks parked on an iceberg" />
	<PhotoGridItem cols={6} src="/images/iceland-2018/kayak2.jpg" alt="Kayak tour guide on the water" />
</PhotoGrid>
...
<Image
	src="/images/iceland-2018/lagoon.jpg"
	alt="Glacier Lagoon"
...
<Image
	src="/images/iceland-2018/hot-spring.jpg"
	alt="Seljavallalaug"
...
<PhotoGrid caption="Various scenes from Vestmannaeyjar">
	<PhotoGridItem cols={6} src="/images/iceland-2018/westman1.jpg" alt="On top of Eldfell volcano looking at the buried town below" />
	<PhotoGridItem cols={6} src="/images/iceland-2018/westman2.jpg" alt="Small inlet" />
	<PhotoGridItem cols={12} src="/images/iceland-2018/westman3.jpg" alt="Hikers on top of Eldfell volcano" />
</PhotoGrid>
...
<PhotoGrid caption="Sites along the Golden Circle, including Þingvellir, Geysir, and Gulfoss">
	<PhotoGridItem cols={4} src="/images/iceland-2018/golden-circle1.jpg" alt="Þingvellir" />
	<PhotoGridItem cols={4} src="/images/iceland-2018/golden-circle2.jpg" alt="Geysir" />
	<PhotoGridItem cols={4} src="/images/iceland-2018/golden-circle3.jpg" alt="Gulfoss" />
</PhotoGrid>
...
<PhotoGrid caption="The library at Nordic House and the Blue Lagoon">
	<PhotoGridItem cols={6} src="/images/iceland-2018/nordic-house.jpg" alt="The library at Nordic House" />
	<PhotoGridItem cols={6} src="/images/iceland-2018/blue-lagoon.jpg" alt="Blue Lagoon" />
</PhotoGrid>

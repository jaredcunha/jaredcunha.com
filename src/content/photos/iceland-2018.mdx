...
<PhotoGrid caption="Our hotel outside of Vík and some areas along the walking trail.">
	...
	<PhotoGridItem cols={12}>
		<Image
			src="/images/iceland-2018/hotel.jpg"
...
<PhotoGrid caption="Kayaking in the glacier lake">
	<PhotoGridItem cols={6}>
		<Image
			src="/images/iceland-2018/kayak1.jpg"
			alt="Kayaks parked on an iceberg"
		/>
	</PhotoGridItem>
	<PhotoGridItem cols={6}>
		<Image
			src="/images/iceland-2018/kayak2.jpg"
...
<PhotoGrid caption="Various scenes from Vestmannaeyjar">
	<PhotoGridItem cols={6}>
		<Image
			src="/images/iceland-2018/westman1.jpg"
			alt="On top of Eldfell volcano looking at the buried town below"
		/>
	</PhotoGridItem>
	<PhotoGridItem cols={6}>
		<Image src="/images/iceland-2018/westman2.jpg" alt="Small inlet" />
	</PhotoGridItem>
	<PhotoGridItem cols={12}>
		<Image
			src="/images/iceland-2018/westman3.jpg"
...
<PhotoGrid caption="Sites along the Golden Circle, including Þingvellir, Geysir, and Gulfoss">
	<PhotoGridItem cols={4}>
		<Image src="/images/iceland-2018/golden-circle1.jpg" alt="Þingvellir" />
	</PhotoGridItem>
	<PhotoGridItem cols={4}>
		<Image src="/images/iceland-2018/golden-circle2.jpg" alt="Geysir" />
	</PhotoGridItem>
	<PhotoGridItem cols={4}>
		<Image src="/images/iceland-2018/golden-circle3.jpg" alt="Gulfoss" />
	</PhotoGridItem>
</PhotoGrid>
...
<PhotoGrid caption="The library at Nordic House and the Blue Lagoon">
	<PhotoGridItem cols={6}>
		<Image
			src="/images/iceland-2018/nordic-house.jpg"
			alt="The library at Nordic House"
		/>
	</PhotoGridItem>
	<PhotoGridItem cols={6}>
		<Image src="/images/iceland-2018/blue-lagoon.jpg" alt="Blue Lagoon" />
	</PhotoGridItem>
</PhotoGrid>

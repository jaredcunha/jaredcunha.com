...
ogImage: '/images/cache-reads.png'
date: '2025-07-29'
---
...
- Continue committing my images to version control? Seems less necessary now, but before I do that, I need to think about social media share images.
- See if my approach with Cloudinary truly holds. If that doesn’t work, I might just need to stop using responsive images.

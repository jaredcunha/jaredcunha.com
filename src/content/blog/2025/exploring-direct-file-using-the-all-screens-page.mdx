...
While this post only covers a tiny portion of Direct File, it’s my favorite feature and one that is now publicly available. All Screens wasn’t the only quality of life improvement we developed either. We developed additional tools along the way.

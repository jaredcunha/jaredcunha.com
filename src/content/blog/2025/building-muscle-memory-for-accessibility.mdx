...
- **Nick**, the base player in the black shirt on the left recorded several albums with [Fairweather](https://equalvision.com/collections/fairweather?srsltid=AfmBOor_wpTjPHb9HweR-EYC62CB29eoBnspwnOfbHWpM38sgWfepJ7I)
- **Pedro**, the guitar in blue in the center of the photo, plays guitar for [The Iron Roses](https://iodinerecords.com/pages/the-iron-roses), sings for [Fire Sale](https://firesaleisaband.bandcamp.com/), and does both for [ShotClock](https://shotclockrichmond.bandcamp.com/)
- **Derek**, who is playing guitar on the right-hand side, runs [Prime Recording](https://primerecording.com/) in Nashville and has worked for artists such as Taylor Swift

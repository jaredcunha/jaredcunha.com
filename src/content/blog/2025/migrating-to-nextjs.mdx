...
<PhotoGrid>
  <PhotoGridItem cols={12} src="/images/ireland-2023/dublin-street0.jpg" alt="" />
  <PhotoGridItem cols={6} src="/images/ireland-2023/dublin-street1.jpg" alt="" />
  <PhotoGridItem cols={6} src="/images/ireland-2023/dublin-street2.jpg" alt="" />
</PhotoGrid>
```
...
<PhotoGrid caption="Home page in both light and dark mode.">
  <PhotoGridItem cols={6} src="/images/next-light.png" alt="Homepage of jaredcunha.com in light mode" />
  <PhotoGridItem cols={6} src="/images/next-dark.png" alt="Homepage of jaredcunha.com in dark mode" />
</PhotoGrid>

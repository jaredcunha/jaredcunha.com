...
date: '2025-11-09'
ogImage: '/images/blogs-2025/triple-diamond.png'
---
...
<PhotoGrid
  caption={
    <>
      I brought my film camera and took a few photos around the building. The
      last photo features cards beautifully design by{' '}
...
<Image
  src="/images/blogs-2025/jared-dotgov.jpg"
  alt="Me speaking in front a group of a people, point to a presentation slide. Several audience members are holding up there phones to take a picture."
  caption={
    <>
      Photo credit:{' '}
      <a href="https://www.linkedin.com/in/cara-campbell56/">Cara Campbell</a>
    </>
  }
/>
...
<Image
  src="/images/blogs-2025/triple-diamond.png"
  ...
  caption="One of the slides from my presentation depicting the UX triple diamond, which doesn’t exist of course"
/>
...
<Image
  src="/images/blogs-2025/whgov.png"
  alt="Screenshot of the whitehouse.gov website"
  caption="The whitehouse.gov website does not have an accessibility statement, nor is the website accessible"
/>
...
- Mention that we're also kind of winging it and that great things can come out of YOLO mode
- I wanted to share a story of a colleague who got really interested in accessibility, decided to pursue getting a professional certification, and has been blogging and presenting about his journey. It was really inspirational!

## Helpful resources related to the talk

- [Deque University screen reader shortcuts and gestures](https://dequeuniversity.com/screenreaders/): Excellent collection of how-tos and setup information for using screen readers and keyboard navigation
- [NVDA Download](https://www.nvaccess.org/download/): Download the NVDA screen reader for your windows device
- [NVDA Screen Reader Basics (YouTube)](https://www.youtube.com/watch?v=Jao3s_CwdRU): YouTube videos for how to use NVDA
- [Coforma’s Accessibility Playbook](https://coforma.io/resources/playbooks/accessibility-playbook)
...
- Find a way to tell a story, but also give the audience something they can take with them
...
<Image
  ...
  alt="Woman riding exercise bike in a spin class. Overlaid is the text: 'shingles doesn't care'"
/>

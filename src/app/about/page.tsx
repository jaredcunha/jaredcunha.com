			...
			<main className="site-wrap site-wrap--contain">
				...
				<div className="prose">
					<p>
						...
						<a href="https://coforma.io">Coforma</a>. I’ve worn a lot of hats
						over the course of my career, but I’ve always enjoyed the sweet spot
					...
					<ul>
						<li>
							<p>
								...
								Product owner. I had built the documentation site working
								closely with other designers and engineers to ensure the

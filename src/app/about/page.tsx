...
export default function About() {
  return (
    <>
      <main>
        <div className="site-wrap site-padding-bottom">
          <h1 className="page-title">About me</h1>
          <div className="prose">
            <p>
              It all began with punk rock. Never did I imagine that when I made
              my first website to promote my band in the mid nineties, it would
              form the basis of a career spanning almost 30 years. Today, I
              serve as Senior Director of Creative Technology at{' '}
              <a href="https://coforma.io">Coforma</a>. Over the course of my
              career, I’ve worn many hats—metaphorically as a hybrid
              designer/engineer, and literally as both the cause of and solution
              to my hairline.
            </p>
            <p>
            ...
            <p>
              I am one of 700,000 people without congressional representation as
        ...
        <section className="content-block prose">
          ...
          <ul>
            <li>
              <p>
                ...
                working closely with other designers and engineers to ensure the
                guidance and principles were well-understood and helpful to
                achieving the goal of designing the best possible digital
            ...
            <li>
              <p>
                ...
                attempts, we managed to get the Small Business Administration’s
                8(a) Business Development Program off paper forms and into an
                online platform used by both small business and the business
                opportunity specialists receiving their applications. In
                conjunction with this work, I also put together a{' '}
            ...
            <li>
              <p>
                ...
                Supplement Nutritional Assistance Program (SNAP) and Medicaid in
          ...
          <p>
            ...
            mobile and tablets. Designed live election results for 2008 and 2012
        ...
        <section className="content-block prose">
          ...
          <ul>
            ...
            <li>
              ...
              and combo box), including updated guidance on using numeric fields
            ...
            <li>
              ...
              where we’re going. I enjoyed the opportunity to speak about the
              work we doing at the U.S. Digital Service.
            </li>
            <li>
              ...
              historic Eisenhower Executive Office Building inside the White
              House campus.
            </li>
            <li>
